<?php /*a:3:{s:67:"/var/www/caves.wcip.net/application/admin/view/shop/order_list.html";i:1572326651;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <form id="multi-check">
            ...
            <tr class="text-c userinfo">
                ...
                <td><span class="order-font-price"><?php echo htmlentities($li['total_price']); ?></span>元 (运费:<span style="color: green"><?php echo htmlentities($li['carriage']); ?></span>元)</td>
            ...
            <tr>
                <td colspan="6">
                    <span style="margin-left: 15px;" onclick="mod_address(this,<?php echo htmlentities($li['id']); ?>,'<?php echo htmlentities($li['address']); ?>')">收货地址: <b><?php echo htmlentities($li['address']); ?></b></span> &nbsp;&nbsp;&nbsp;&nbsp;(收货人: <b><?php echo htmlentities($li['receiver']); ?></b> | 手机号: <b><?php echo htmlentities($li['tel']); ?></b> ) <a data-title="物流信息"  onclick="layer_show('物流信息','<?php echo url("Shop/traceInfo",array('id'=>$li['id'])); ?>',600,500)" href="javascript:;" class="btn btn-link">查看物流</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </form>
