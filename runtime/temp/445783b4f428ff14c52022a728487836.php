<?php /*a:3:{s:67:"/var/www/caves.wcip.net/application/admin/view/req/work_detail.html";i:1571799476;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class=""><?php echo htmlentities($info['vote']); ?></span>
            </div>
        </div>
        <?php if($info['idea_title']): ?>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">创意名称：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <span class=""><?php echo htmlentities($info['idea_title']); ?></span>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">创意内容：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <p class=""><?php echo htmlentities($info['idea_content']); ?></p>
            </div>
        </div>
        <?php else: ?>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="desc" cols="" rows="" class="textarea" maxlength="500" placeholder="" oninput="this.value.length<=500?$('#textlen1').text(this.value.length):$('#textlen1').text(500)" ><?php echo htmlentities($info['desc']); ?></textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class=""><?php echo htmlentities($info['req_title']); ?> (<?php echo htmlentities($info['org']); ?>) </span>
            </div>
        </div>
        <div class="row cl">
