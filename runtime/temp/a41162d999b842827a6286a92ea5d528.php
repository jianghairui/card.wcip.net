<?php /*a:3:{s:71:"/var/www/caves.wcip.net/application/admin/view/funding/funding_add.html";i:1570842584;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="form form-horizontal" id="form-article-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-4 col-sm-4">
                ...
                <select class="select" name="work_id" id="work_id">
                    <?php foreach($worklist as $v): ?>
                    <option value="<?php echo htmlentities($v['id']); ?>" ><?php echo htmlentities($v['title']); ?> (id: <?php echo htmlentities($v['id']); ?>)</option>
                    <?php endforeach; ?>
				</select>
                </span>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="输入众筹标题" id="title" name="title" maxlength="50">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">目标金额：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" class="input-text" value="" placeholder="金额格式 0.00" id="need_money" name="need_money" onkeyup="onlyNumber(this)">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>众筹开始时间：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" id="start_time" name="start_time" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'#F{ $dp.$D(\'end_time\')}' })" value="" class="input-text Wdate">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>众筹结束时间：</label>
            <div class="formControls col-xs-4 col-sm-4">
                <input type="text" id="end_time" name="end_time" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{ $dp.$D(\'start_time\')}' })" value="" class="input-text Wdate">
            </div>
        </div>
        <div class="row cl">
        ...
        $("#form-article-add").validate({
            ...
            submitHandler:function(form){
                if(isclick === true) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'post',
                        url: "<?php echo url('Funding/fundingAdd'); ?>" ,
