<?php /*a:3:{s:69:"/var/www/caves.wcip.net/application/admin/view/shop/goods_detail.html";i:1571381607;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<article class="page-container">
    <form class="form form-horizontal" id="form-article-add">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span>
                    <select class="select" name="shop_id" id="shop_id">
                        ...
                        <option value="<?php echo htmlentities($li['id']); ?>"  <?php if($li['id'] == $info['shop_id']): ?>selected<?php endif; ?>>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-4"> <span class="select-box">
				<select class="select" name="pcate_id" id="pcate_id">
					...
					<option value="<?php echo htmlentities($li['id']); ?>" <?php if($info['pcate_id'] == $li['id']): ?>selected<?php endif; ?>><?php echo htmlentities($li['cate_name']); ?></option>
                    <?php endforeach; ?>
				</select>
				</span>
            </div>
            <div class="formControls col-xs-8 col-sm-4"> <span class="select-box">
				<select class="select" name="cate_id" id="cate_id">
                    <?php foreach($child as $li): ?>
					<option value="<?php echo htmlentities($li['id']); ?>" <?php if($info['cate_id'] == $li['id']): ?>selected<?php endif; ?>><?php echo htmlentities($li['cate_name']); ?></option>
                    <?php endforeach; ?>
				</select>
				</span>
            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['name']); ?>" placeholder="" id="name" name="name" maxlength="50">
            </div>
        </div>
        <div class="row cl">
                ...
                <ul class="cl portfolio-area my-style" id="fileList">
                    ...
                    <li class="item">
                        <div class="portfoliobox">
                            ...
                            <div class="picbox">
                                <a href="<?php echo htmlentities($qiniu_weburl); ?><?php echo htmlentities($v); ?>" data-lightbox="gallery" data-title="" style="background-image: url('<?php echo htmlentities($qiniu_weburl); ?><?php echo htmlentities($v); ?>')"></a>
                            </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['origin_price']); ?>" placeholder="金额格式 0.00" id="origin_price" name="origin_price" onkeyup="onlyNumber(this)">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商品价格：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['price']); ?>" placeholder="金额格式 0.00" id="price" name="price" onkeyup="onlyNumber(this)">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">使用规格：</label>
            <div class="formControls col-xs-8 col-sm-10">
                <input type="checkbox" id="use_attr" name="use_attr" value="1" style="width: 20px;height: 20px" <?php if($info['use_attr']): ?>checked<?php endif; ?>>
            </div>
        </div>
        <?php if($info['use_attr']): ?>
        <div class="row cl" id="attr_detail">
            <div class="row cl">
                <label class="form-label col-sm-2">规格组：</label>
                <div class="formControls col-sm-4">
                    <input type="text" class="input-text" value="<?php echo htmlentities($info['attr']); ?>" placeholder=“(如颜色、尺寸)" id="attr" name="attr">
                </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-sm-2">
                    <input type="hidden" class="input-text" value="<?php echo htmlentities($li['id']); ?>" name="attr0[]">
                    <input type="text" class="input-text" value="<?php echo htmlentities($li['value']); ?>" name="attr1[]" maxlength="20">
                </div>
                <div class="formControls col-sm-2">
                    <input type="text" class="input-text" value="<?php echo htmlentities($li['price']); ?>" name="attr2[]" onkeyup="onlyNumber(this)">
                </div>
                <div class="formControls col-sm-2">
                    <input type="number" class="input-text" value="<?php echo htmlentities($li['stock']); ?>" name="attr3[]" maxlength="8">
                </div>
            </div>
            <?php endforeach; ?>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['carriage']); ?>" placeholder="金额格式 0.00" id="carriage" name="carriage" onkeyup="onlyNumber(this)">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">商家服务：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['service']); ?>" placeholder="7天无理由退换" id="service" name="service" maxlength="30">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">单位：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="<?php echo htmlentities($info['unit']); ?>" placeholder="单位:件" id="unit" name="unit" maxlength="10">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">库存：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text" value="<?php echo htmlentities($info['stock']); ?>" placeholder="输入数字" id="stock" name="stock" maxlength="8">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">排序：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text" value="<?php echo htmlentities($info['sort']); ?>" placeholder="输入数字" id="sort" name="sort" maxlength="8">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">销量：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text" value="<?php echo htmlentities($info['sales']); ?>" placeholder="输入数字" id="sales" name="sales" maxlength="8">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="hot" type="radio" id="hot" value="1" <?php if($info['hot'] == 1): ?>checked<?php endif; ?>>
                    <label for="hot">是</label>
                </div>
                <div class="radio-box">
                    <input name="hot" type="radio" id="cool" value="0" <?php if($info['hot'] == 0): ?>checked<?php endif; ?>>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box">
                    <input name="status" type="radio" id="on" value="1" <?php if($info['status'] == 1): ?>checked<?php endif; ?>>
                    <label for="on">上架</label>
                </div>
                <div class="radio-box">
                    <input name="status" type="radio" id="off" value="0" <?php if($info['status'] == 0): ?>checked<?php endif; ?>>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea id="editor" type="text/plain" name="detail" style="width:100%;height:400px;">
        ...
        $("#form-article-add").validate({
            ...
            submitHandler:function(form){
                ...
                if(isclick === true) {
                    ...
                    $(form).ajaxSubmit({
                        type: 'post',
                        url: "<?php echo url('Shop/goodsModPost'); ?>" ,
