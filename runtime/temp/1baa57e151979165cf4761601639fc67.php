<?php /*a:3:{s:65:"/var/www/caves.wcip.net/application/admin/view/tmp/join_list.html";i:1574403005;s:58:"/var/www/caves.wcip.net/application/admin/view/layout.html";i:1566381559;s:65:"/var/www/caves.wcip.net/application/admin/view/public/footer.html";i:1566381559;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">/</span> 临时活动 <span class="c-gray en">/</span> 参加记录 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tr class="text-c userinfo">
            ...
            <td><?php echo htmlentities($li['weixin']); ?></td>
        </tr>
        <?php endforeach; ?>
...
<script type="text/javascript">
    ...
    var url = '<?php echo url("Tmp/joinList"); ?>' + '?<?php echo $page["query"];?>';
    ...
    $("#search-btn").click(function () {
        ...
        window.location.href = '<?php echo url("Tmp/joinList"); ?>' + '?' + str;
    });

    function contact(obj,id) {
        layer.confirm('确认已联系过吗？',function(index){
            $.ajax({
                url: "<?php echo url('Tmp/joinContact'); ?>",
                type: 'POST',
                dataType: 'json',
                data:{id:id},
